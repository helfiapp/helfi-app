    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-2 z-40">
        <div className="flex items-center justify-around">
          ...
          <Link href="/onboarding?step=1" className="pressable ripple flex flex-col items-center py-2 px-1 min-w-0 flex-1">
            <div className="icon text-gray-400">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2z"/></svg>
            </div>
            <span className="label text-xs mt-1 truncate text-gray-400 font-medium">Intake</span>
          </Link>
