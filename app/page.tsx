          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border border-blue-200 rounded-2xl p-8 max-w-5xl mx-auto shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-green-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">30 AI food photo analyses per day with 30 reanalysis credits. Get instant nutritional breakdowns.</p>
                </div>
                
                <div className="bg-white rounded-xl p-6 shadow-sm border border-blue-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">30 medical photo analyses per day for rashes, moles, skin conditions. AI-powered observations.</p>
                </div>
                
                <div className="bg-white rounded-xl p-6 shadow-sm border border-purple-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">Full medication & supplement interaction analysis. Stay safe with automatic conflict detection.</p>
                </div>
              </div>
