  ...
  try {
    ...
    await prisma.$executeRaw`
      ...
      (${templateId4}, 'Feature Announcement', 'ANNOUNCEMENTS', '🆕 Exciting New Features Just Dropped at Helfi!',
       'Hi {name},\n\nBig news! We''ve just released some helpful new features for your health tracking:\n\n🔥 What''s New:\n• Enhanced AI food notes with better accuracy\n• New health image notes for tracking visible changes\n• Improved medication interaction checks\n• Faster mobile app performance\n• Smart health insights dashboard\n\n✨ Ready to explore? Log in to your Helfi account and discover these tools.\n\n[Explore New Features - helfi.ai]\n\nYour feedback helps us build better health tools. Let us know what you think!\n\nBest regards,\nThe Helfi Team',
       true, ${admin.adminId}),
