  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <p className="mt-2 text-sm text-gray-500 text-center">Preview-only access. Uses direct session cookie.</p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500"
              placeholder="Any value for staging"
            />
          </div>
          {error && (
        ...
        <p className="mt-4 text-xs text-gray-400 text-center">This page exists only for staging/preview testing.</p>
      </div>
    </div>
  )
}
