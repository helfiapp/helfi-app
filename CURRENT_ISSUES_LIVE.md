...
- Where to see it (page/link): https://helfi.ai, https://www.helfi.ai, and the physical iPhone Home Screen; source commit `c3200ba3`, live deployment `dpl_EeCtEqqvc4LTFxPbqf5BncBf2Fde`.
- What to quickly test: On the last iPhone Home Screen page, confirm “Helfi AI” (native) and “Helfi” (web shortcut) both show the same sharp approved opaque green leaf and open correctly. Confirm Helfi Admin on the previous page remains unchanged.
...
- Where to see it (page/link): App Store Connect / TestFlight build 23. It shows Ready to Submit.
- What to quickly test: Install TestFlight build 23 on a real iPhone and iPad. Retest Food Diary, Talk to Helfi, Symptom Notes, Health Image Notes, Insights, Settings, Billing, camera/photo, barcode, Apple Health, microphone, purchases, and Fitbit/Garmin linking.
...
- What to quickly test: Open Practitioner Outreach, click Load Australia Starter List, accept the confirmation popup, and confirm hundreds of NOT_REVIEWED contacts appear with no emails sent automatically.

DEPLOYED:
- LIVE or STAGING: LIVE
- Date/time: 9 June 2026, 12:45 AM AEST
- What changed: Expanded the Australia practitioner outreach starter list from a tiny sample to 233 unique public clinic/business contacts, covering every main Helfi practitioner category. All contacts stay NOT_REVIEWED until manually checked and approved.
- Where to see it (page/link): https://helfi.ai/admin-panel -> Practitioner Outreach -> Load Australia Starter List
- What to quickly test: Open Practitioner Outreach, click Load Australia Starter List, confirm hundreds of contacts load, and confirm the list includes all main categories with no emails sent automatically.
...
- What to quickly test: Signed out: open the first 3 pages and confirm website menu + no dashboard button. Signed in as normal user: open the same 3 pages and confirm only `Back` + `Go to Dashboard`. Open `/auth/signin` and confirm `Back` is visible and returns to previous page.
...
- What to quickly test: While logged in, open `/list-your-practice/start` and confirm `Back to dashboard` is shown. From app/native flow open `Find a practitioner` and confirm the top right no longer shows `Log in` / `Sign up`.
