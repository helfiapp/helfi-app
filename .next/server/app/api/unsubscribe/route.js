"use strict";(()=>{var e={};e.id=297,e.ids=[297],e.modules={53524:e=>{e.exports=require("@prisma/client")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},48391:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>f,originalPathname:()=>y,patchFetch:()=>g,requestAsyncStorage:()=>d,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>h,staticGenerationBailout:()=>b});var i={};r.r(i),r.d(i,{GET:()=>u,POST:()=>p});var s=r(95419),o=r(69108),a=r(99678),n=r(78070),l=r(3214);async function u(e){try{let{searchParams:t}=new URL(e.url),r=t.get("email"),i=t.get("token");if(!r||!i)return new Response(`
        <html>
