...
### Current checklist
- ✅ Overflow menu now shows “Show Nutrition Summary” and opens the entry’s detail view.
- ✅ Tapping a food entry opens the full detail view; the Edit button there now lands on the real edit flow.
- ☐ Mobile swipe gestures for entry actions (Cronometer-style left/delete, right/menu).
- ☐ Remaining layout, multi-select, and copy/paste upgrades listed below.
