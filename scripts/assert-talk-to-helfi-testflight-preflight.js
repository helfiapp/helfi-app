...
assert(voiceAssistant.includes('realtimeVoiceConnectTimeoutRef') && voiceAssistant.includes('REALTIME_VOICE_CONNECT_TIMEOUT_MS = 8000') && voiceAssistant.includes('Live voice could not connect quickly enough'), 'Realtime startup must fail within eight seconds instead of hanging.')
