 ...
 *   export GARMIN_OAUTH_BASE_URL=https://connectapi.garmin.com/oauth-service/oauth
 */
...
const DEFAULT_OAUTH_BASE_URL = 'https://connectapi.garmin.com/oauth-service/oauth'
...
async function main() {
  ...
  const oauthBaseUrl = process.env.GARMIN_OAUTH_BASE_URL || DEFAULT_OAUTH_BASE_URL
  ...
  if (!consumerKey || !consumerSecret) {
    ...
    console.error(`  GARMIN_OAUTH_BASE_URL=${DEFAULT_OAUTH_BASE_URL}`)
    process.exit(1)
  }
  ...
  const envVars = [
    ...
    { key: 'GARMIN_OAUTH_BASE_URL', value: oauthBaseUrl, type: 'plain' },
  ]
