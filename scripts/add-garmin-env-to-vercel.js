 ...
 *   export GARMIN_API_BASE_URL=https://apis.garmin.com/wellness-api/rest
 *   export GARMIN_OAUTH_AUTHORIZE_URL=https://connect.garmin.com/oauth2Confirm
 *   export GARMIN_OAUTH_TOKEN_URL=https://diauth.garmin.com/di-oauth2-service/oauth/token
 */
...
const DEFAULT_OAUTH_AUTHORIZE_URL = 'https://connect.garmin.com/oauth2Confirm'
const DEFAULT_OAUTH_TOKEN_URL = 'https://diauth.garmin.com/di-oauth2-service/oauth/token'
...
async function main() {
  ...
  const oauthAuthorizeUrl = process.env.GARMIN_OAUTH_AUTHORIZE_URL || DEFAULT_OAUTH_AUTHORIZE_URL
  const oauthTokenUrl = process.env.GARMIN_OAUTH_TOKEN_URL || DEFAULT_OAUTH_TOKEN_URL
  ...
  if (!consumerKey || !consumerSecret) {
    ...
    console.error(`  GARMIN_OAUTH_AUTHORIZE_URL=${DEFAULT_OAUTH_AUTHORIZE_URL}`)
    console.error(`  GARMIN_OAUTH_TOKEN_URL=${DEFAULT_OAUTH_TOKEN_URL}`)
    process.exit(1)
  }
  ...
  const envVars = [
    ...
    { key: 'GARMIN_OAUTH_AUTHORIZE_URL', value: oauthAuthorizeUrl, type: 'plain' },
    { key: 'GARMIN_OAUTH_TOKEN_URL', value: oauthTokenUrl, type: 'plain' },
  ]
